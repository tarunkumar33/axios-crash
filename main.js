...
function getTodos() {
  ...
  //bydefault it is get. but using get makes it more readable
...
// PUT/PATCH REQUEST
function updateTodo() {
  // axios.put('https://jsonplaceholder.typicode.com/todos/1',{title:'new todo',completed:false})
  // .then(res=>showOutput(res))
  // .catch(err=>console.log(err));
...
// which will allow us to run some kind of functionality like logger
